...
import com.fjcw.cms.constant.ArticleConstant.check;
...
public interface ArticleDao {
	...
	public ArticleVo getArticleNextByCurrId(@Param("articleId") long articleId,@Param("folderId") long folderId);
	public ArticleVo getArticlePrevByCurrId(@Param("articleId") long articleId,@Param("folderId") long folderId);
	 ...
	 * @return List<FileVo>
	 */
	public List<ArticleVo> getArticleListOfDisplayByRecType(
			@Param("recType") int recType, @Param("offset") long offset,
			@Param("rows") long rows);
	...
	public List<ArticleVo> getArticleListByPath(@Param("path") String path);
	
	public List<ArticleVo> searchArticleListByKey(@Param("path") String path,@Param("key") String key,@Param("offset") long offset, @Param("rows") long rows);
	
	public Integer searchArticleListByKeyCount(@Param("key") String key);
