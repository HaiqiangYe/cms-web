 ...
 */
@Service
public class FolderListSecondTag extends TagPlugin {
	@Autowired
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		try {
			...
			list = folderService.getFolderListByFatherId(folderService.secondFolderId(folderId),
					FolderConstant.status.display);
		} catch (Exception e) {
			// 丢弃
		}
		env.setVariable("tag_folder_second_list", DEFAULT_WRAPPER.wrap(list));
