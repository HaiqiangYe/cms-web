...
public class ArticleAction extends BaseAction {
	...
	public String article(@PathVariable long articleId,
		...
		try {
			...
			ArticleVo prevArticle=fileService.getArticlePrevByCurrId(articleId,folderId);
			modelMap.addAttribute("prevArticle", prevArticle);
			ArticleVo nextArticle=fileService.getArticleNextByCurrId(articleId,folderId);
			...
			Folder fatherFolder=folderService.getFolderById(gFolderId);
			modelMap.addAttribute("folder", fatherFolder);
			modelMap.addAttribute("fatherFolder", fatherFolder);
