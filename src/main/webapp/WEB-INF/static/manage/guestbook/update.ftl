				...
				<div class="panel-body">
					<form id="reply_message_form" method="post"
						...
						<div class="rows">
							...
							<div class="col-xs-6">
								<p class="guesbook_size"><b>电话&nbsp;:&nbsp;</b>${guestbook.email}</p>
							</div>	
						</div>
						<div class="rows">
							<div class="col-xs-12">
						...
						<div class="rows">
							<div class="col-xs-12">
								<p class="guesbook_size" style="margin-top:25px;"><b>处理情况：</b></p>
						...
						<div class="rows">
							<div class="col-xs-12">
								<p class="guesbook_size"><b>状态：</b>
									<input type="radio"
												name="status" value="hidden" <#if guestbook.status =="hidden"> checked </#if>/> 挂起
									<input type="radio"
												name="status" value="display" <#if guestbook.status !="hidden"> checked </#if> /> 已处理
								</p>						
							</div>							
						</div>
						<div class="rows">
