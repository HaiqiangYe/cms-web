					...
					<section class="panel">
						...
						<div class="panel-body">
							<div class="form-group">
	                          <label class="col-sm-2 col-sm-2 control-label">广告</label>
	                          <div class="col-sm-10">
	                          	<img src="${BASE_PATH}/${folder.picture!}" alt="img04" style="height:120px;width:100%">
	                        ...
	                        <div class="form-group">
	                          ...
	                          <div class="col-sm-10">
	                              <input type="text" style="font-size:15px;width: 300px;" class="form-control" name="title"
	                              	placeholder="目录英文名" id="ename" value="${folder.title!}">
	                              </input>
	                          </div>
	                        </div> 
                        	<div class="form-group">
	                          <label class="col-sm-2 col-sm-2 control-label">目录编码</label>
	                          <div class="col-sm-10">
	                              <input type="text" style="font-size:15px;width: 300px;" class="form-control" name="ename"
	                              	placeholder="目录编码" id="ename" value="${folder.ename}">
	                              </input>
	                          </div>
	                        </div>
	                        <div class="form-group">
