			...
			<div class="col-lg-12">
				<section class="panel">
					...
					<div class="panel-body">
						...
						<div class="form-group">
                          <label class="col-sm-2 col-sm-2 control-label">标题/姓名</label>
                          <div class="col-sm-10">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <input type="text" style="font-size:15px;width: 300px;" class="form-control" name="role"
                              	placeholder="角色" id="name" value="${article.role!}">
                              </input>
                          </div>
                        </div>
                        <div class="form-group">
                          ...
                          <input name="recType" value="0" type="radio" <#if article.recType==0>checked</#if>> 不推荐&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input name="recType" value="1" type="radio" <#if article.recType==1>checked</#if>> 推荐首页&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input name="recType" value="2" type="radio" <#if article.recType==2>checked</#if>> 推荐新闻&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <input name="recType" value="3" type="radio" <#if article.recType==3>checked</#if>> 推荐案例&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          </div>
                        </div>
                        <div class="form-group">
