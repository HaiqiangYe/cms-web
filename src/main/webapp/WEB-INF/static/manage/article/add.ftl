			...
			<div class="col-lg-12">
				<section class="panel">
					...
					<div class="panel-body">
						...
						<div class="form-group">
                          <label class="col-sm-2 col-sm-2 control-label">文章标题/姓名</label>
                          <div class="col-sm-10">
                        ...
                        <div class="form-group">
                          ...
                          <input name="recType" value="0" type="radio" checked> 不推荐&nbsp;&nbsp;
                        
                          <input name="recType" value="1" type="radio"> 推荐首页&nbsp;&nbsp;
                          <input name="recType" value="2" type="radio"> 推荐新闻&nbsp;&nbsp;
                          <input name="recType" value="3" type="radio"> 推荐案例&nbsp;&nbsp;
                          </div>
                        </div>
                        <div class="form-group">
