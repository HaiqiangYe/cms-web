		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="">
						<a <#if menu="system">class="active"</#if> href="${BASE_PATH}/manage/config/basic.htm"> <i class="icon-book"></i> <span>网站信息</span></a>
					</li>
					<li class="">
						<a <#if menu="article">class="active"</#if> href="${BASE_PATH}/manage/article/list.htm"> <i class="icon-book"></i> <span>文章列表</span></a>
					</li>
					<li class="">
						<a <#if menu="articleLink">class="active"</#if> href="${BASE_PATH}/manage/articleLink/list.htm"> <i class="icon-book"></i> <span>链接列表</span></a>
					</li>
					<li class="sub-menu">
